...
<head>
    ...
    <meta name="description" content="Site officiel de Old School P'zzas au 155 Route nationale, Ville.">
    ...
    <meta property="og:description" content="Site officiel de Old School P'zzas au 155 Route nationale, Ville.">
    ...
    <meta property="twitter:description" content="Site officiel de Old School P'zzas au 155 Route nationale, Ville.">
    ...
    <script>
        alert("Suite a l'utilisation de l’hébergent depuis Github le PHP ne marche pas alors si tu le site ne fonctionne pas c'est normal");
    </script>
    <title>Pizzeria - Old School P'zzas</title>
</head>
...
<body>
    ...
    <section id="presentation">
        <div class="titre">
            ...
            <span>155 route nationale<br>54842 <span class="uppercase">Ville</span><br>06 55 33 01 74</span>
        </div>
                ...
                <a href="pages/produit.php?idProduit=<?= $id ?>">
                    <div class="pizza">
                        ...
                        <div class="nom-pizza"><?= $nom_produit ?>
                            <br><span class="prix"><?= $prix ?>€</span>
                        </div>
                        <?php if ($new == 1) {
                            echo '<div class="notif"><p>Nouveaute</p></div>';
                        } ?>
                    </div>
                </a>
                <?php }
            ...
            ?>
                <a href="pages/produit.php?idProduit=<?= $id ?>">
                    <div class="pate">
                        ...
                        <?php if ($new == 1) {
                            echo '<div class="notif"><p>Nouveauté</p></div>';
                        } ?>
                    </div>
                </a>
                <?php
    ...
    <section id="footer">
        ...
        <div class="contact">
            ...
            <ul class="list">
                ...
                <li class="list-item"><a href="tel:06 95 13 00 79">06 55 33 01 74</a></li>
            </ul>
        </div>
